...
function renderPrice(){
  let price = wholeWheatBun*2 + ingredients.Patty * state.Patty +
              ingredients.Cheese * state.Cheese + ingredients.Tomatoes * state.Tomatoes +
              ingredients.Onions * state.Onions + ingredients.Lettuce * state.Lettuce;
